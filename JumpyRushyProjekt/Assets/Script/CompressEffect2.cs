...
public class CompressEffect2 : MonoBehaviour
{
    ...
    public static bool loadingDoneEffect2 = false;
    ...
    void startCMP()
    {
        ...
        while (st <= 3)
        {
            ...
            {
                stopnja = 0;
                fName = "/visokaE2CMP.wav";
            }
            else if (st == 2)
            {
                stopnja = 30;
                fName = "/srednjaE2CMP.wav";
            }
            else if (st == 3)
            {
                stopnja = 55;
                fName = "/nizkaE2CMP.wav";
            }
